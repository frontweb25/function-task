...
document.querySelector('.b-1').addEventListener('click', function () {
    document.querySelector('.out-1').innerHTML = t1(0, 10);
})
...
document.querySelector('.b-2').addEventListener('click', () => {
    document.querySelector('.out-2').innerHTML = t2(20, 44);
});
...
document.querySelector('.b-3').addEventListener('click', () => {
    document.querySelector('.out-3').innerHTML = t3(10, 4, 55);
});
...
document.querySelector('.b-4').addEventListener('click', () => {
     t4([5,6,78,8,9], document.querySelector('.out-4'));
});
...
const t6 = (arrReverse) => {
    return arrReverse.reverse().join(' ');
};
...
let a8 = [1997, 1997, 1997, 1997, 1997];
let year = 1996;
...
const t9 = (arr, ...num) => {
    const newArray = [];
    newArray.push([...arr, num].join(' '));
    return newArray;
};

document.querySelector('.b-9').addEventListener('click', () => {
    document.querySelector('.out-9').innerHTML = t9([1, 2 ,3], 10, 20);
});
...
document.querySelector('.b-10').addEventListener('click', () => {
    document.querySelector('.out-10').innerHTML = t9([1, 2 ,3], 10, 20, 40);
});
