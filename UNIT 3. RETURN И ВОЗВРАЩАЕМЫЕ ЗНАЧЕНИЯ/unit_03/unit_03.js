...
function t5() {
    const s51Number = +document.querySelector('.s51').value;
    const s53Number = +document.querySelector('.s53').value;
    const s52Operator = document.querySelector('.s52').value;
    let sum;
    if(s52Operator === '-') {
       sum = s51Number - s53Number;
    } else if(s52Operator === '+') {
        sum = s51Number + s53Number;
    }else if(s52Operator === '*') {
        sum = s51Number * s53Number;
...
document.querySelector('.b-7').addEventListener('click', function () {
    document.querySelector('.out-7').textContent = t7(5);
});
...
document.querySelector('.b-9').addEventListener('click', function () {
    document.querySelector('.out-9').textContent = t9(4, 2);
});
...
function t26() {
    ...
    if(i26 === ''){
       ...
       out26.innerHTML = i26.toLowerCase();
    }
}
